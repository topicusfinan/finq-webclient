#[Finq Webclient](http://finq.io) [![Stories in Ready](https://badge.waffle.io/topicusfinan/finq-webclient.svg?label=ready&title=Ready)](http://waffle.io/topicusfinan/finq-webclient) [![Dependencies](https://david-dm.org/topicusfinan/finq-webclient.png)](https://david-dm.org/topicusfinan/finq-webclient) [![Build Status](https://travis-ci.org/topicusfinan/finq-webclient.svg?branch=master)](https://travis-ci.org/topicusfinan/finq-webclient)
