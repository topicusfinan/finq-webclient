...
describe('Unit: AuthenticateService initialization', function() {
    ...
    it('should properly handle a failed authentication', function () {
    ...
    it('should be able to authenticate automatically if the server responds with an OK', function () {
    ...
    it('should be able to handle a failed login attempt', function () {
